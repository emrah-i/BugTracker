    ...
    return(<div className="flex flex-col justify-center items-center h-screen">
                ...
                <div className="flex flex-col justify-between items-center rounded-lg shadow-2xl w-1/3 h-1/2 text-main-color bg-sec-color p-5">
                    <form className="w-3/5 h-full flex flex-col justify-center gap-3 items-center">
                        ...
                        <input className="w-full rounded-full shadow-md py-1.5 px-3 text-black" type="text" name="username" placeholder="Username" />
                        <input className="w-full rounded-full shadow-md p-1.5 px-3 text-black" type="password" name="password" placeholder="Password" />
                        <p className="w-full text-sm text-right mb-2"><a className="w-min hover:underline" href="/forgot-password">Forgot Password?</a></p>
                        <button className="text-lg text-sec-color shadow-md bg-main-color rounded-lg py-1 px-2 hover:rounded-xl duration-300" type="button">Login</button>
                    </form>
