...
function Nav() {
    return(<nav className="flex flex-col items-center w-1/5 h-screen bg-third-color text-black custom-shadow py-5">
                ...
                <div className="flex flex-col items-start gap-3 mt-10 h-full text-lg">
                    ...
                    <a className="nav-link" href="/manage"><i class="nav-icon fa-solid fa-diagram-project"></i> Projects</a>
                    ...
                    <a className="nav-link" href="/my-tickets"><i class="nav-icon fa-solid fa-book"></i> All Tickets</a>
                    <a className="nav-link" href="/my-tickets"><i class="nav-icon fa-solid fa-list"></i> My Tickets</a>
                    <a className="nav-link" href="/new-ticket"><i class="nav-icon fa-solid fa-ticket"></i> New Ticket</a>
