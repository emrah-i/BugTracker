...
function AllTickets() {
    ...
    return (<div className="flex flex-col mx-5 pb-5">
                ...
                <TicketsTable title={"All Current Tickets"} projects={projects} selectedTicket={selectedTicket} setSelectedTicket={setSelectedTicket} />
                <TicketsTable title={"All Past Tickets"} projects={projects} selectedTicket={selectedTicket} setSelectedTicket={setSelectedTicket} />
            </div>)
