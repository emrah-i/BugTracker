...
function TopNav() {
    ...
    return(<div className="flex justify-between items-center w-full h-min py-3 px-8 bg-main-color shadow-md">
             ...
             <div className="relative">
                ...
                <ul className="flex flex-col justify-evenly items-start text-sm absolute bg-black text-white rounded px-3 right-0 list-none pointer-events-none h-0 opacity-0 duration-300" ref={dropdownMenu}>
